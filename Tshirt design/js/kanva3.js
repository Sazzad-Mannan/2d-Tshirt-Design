...
$("#txt3").on('click', function() {
  ...
  var textNode = new Konva.Text({
      ...
      textNode.on('dblclick dbltap', () => {
        ...
        var areaPosition = {
          x: stage3.container().offsetLeft + textPosition.x-10,
          y: stage3.container().offsetTop + textPosition.y,
        };

        // create textarea and style it
        var textarea = document.createElement('textarea');
        document.getElementById("container3").appendChild(textarea);
...
$("#file_input3").change(function(e){
    ...
    img.onload = function() {
      ...
      layer3.add(selectionRectangle2);
      ...
      stage3.on('mousedown touchstart', (e) => {
        ...
        x1 = stage3.getPointerPosition().x;
        y1 = stage3.getPointerPosition().y;
        x2 = stage3.getPointerPosition().x;
        y2 = stage3.getPointerPosition().y;
      ...
      stage3.on('mouseup touchend', () => {
        ...
        var shapes = stage3.find('.img').toArray();
 ...
 $(".gallery3 img").on('click', function() {
...
var url = $(this).attr('src');
   ...
   img2.onload = function() {
      ...
      stage3.on('mouseup touchend', () => {
        ...
        var shapes = stage3.find('.img2').toArray();
        var box = selectionRectangle2.getClientRect();
        var selected = shapes.filter((shape) =>
          Konva.Util.haveIntersection(box, shape.getClientRect())
        );
...
var menuNode = document.getElementById('menu');
        document.getElementById('delete-button').addEventListener('click', () => {
          const tr = layer3.find('Transformer').toArray().find(tr => tr.nodes()[0] === currentShape3);
          tr.remove();
          currentShape3.remove();
          layer3.draw();
        });
        ...
        stage3.on('contextmenu', function (e) {
          ...
          currentShape3 = e.target;
          console.log(currentShape3);
          // show menu
          menuNode.style.display = 'initial';
          var containerRect = stage3.container().getBoundingClientRect();
          menuNode.style.top =
            containerRect.top + stage3.getPointerPosition().y + 4 + 'px';
          menuNode.style.left =
            containerRect.left + stage3.getPointerPosition().x + 4 + 'px';
        });
  $("#dwn3").on('click', function() {

html2canvas(document.querySelector(".work_div2")).then(canvas => {
  canvas.id = 'someId3';
    document.querySelector(".preview3").prepend(canvas)
});
  $(".pr3").show();

 });
download_img3 = function(el) {
var canvas=document.getElementById("someId3");
